...
async function status(request, response) {
  ...
  const databaseMaxConnections = databaseResultMaxConnections.rows[0].max_connections;
  ...
  const databaseOpenedConnections = databaseOpenedConnectionsResults.rows[0].count;
